...
<p>АКЦИЯ!</p><br><br>
Сделайте любую покупку сейчас и получите 50% скидки!
<img id="cl" src="media/wClose.png" width="30" height="30"/>
<div id="timer"> 
</div>
...
<div class="Block_1_Header">
  ...
  <div class="prev_M"> < </div>
  <div class="next_M"> > </div>
<div class="Slider_List_DOP">
...
<div class="Block_2_Safari">
  ...
  <div class="sumkaBlock">
    <div class="krugSumka"><p>Сумка-тоут с ручками из бамбука была впервые представлена Gucci в 1991 году. 
    Gucci "Safari" теперь выпущена в новой вариации со съемными ремешками из кожи питона. </p>
    </div>
    <img id="sumka1" src="media/sumka1.png" width="450" height="355"/>
    <img id="sumka2" src="media/sumka2.png" width="450" height="355"/>
    <span></span>
    <div class="prev"> < </div>
    <div class="next"> > </div>
...
<div class="safari_text"> 
    <img src="media/bag_2.png" width="150" height="150" alt="">    
    <p>Сумка "Safari"</p> Новый дизайн - новая ты! 
...
<div class="Block_5_FotoLink">
    ...
    <div class="blokFoto_2">
      <a href="http://localhost/Portfolio/gucci/php/catalog/access.php"><img id="bl_foto_men" src="media/fotoLink_77.png" width="44%" height="500"/></a>
      <a href="http://localhost/Portfolio/gucci/php/catalog/women.php"><img  id="women" src="media/fotoLink2.jpg" width="55%" height="500"/></a>
    </div>
