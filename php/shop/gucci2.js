...
$('.zoom_img_item').on('mousemove', function(){
	...
	let overlay = $('.zoom_img_overlay');
	let cursor = $('.zoom_img_cursor');
...
$('.zoom_img_item3').on('mousemove', function(){
	...
	let imgHeight3 = imgBlock3.height();
	let overlay3 = $('.zoom_img_overlay3');
	let cursor3 = $('.zoom_img_cursor3');
	cursor3.css('width', overlay3.width() / zoom3 + 'px');
	cursor3.css('height', overlay3.height() / zoom3 + 'px');
	let cursorWidth3 = cursor3.outerWidth();
...
$('.zoom_img_item3').on('mouseleave', function(){
	$('.zoom_img_cursor3').hide();
	$('.zoom_img_overlay3').hide();
});
